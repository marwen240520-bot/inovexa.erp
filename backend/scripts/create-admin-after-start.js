...
async function createAdmin() {
  try {
    ...
    if (!tableCheck.rows[0].exists) {
      console.log('⚠️ La table users n\'existe pas encore. Attendez que le backend ait fini de créer les tables.');
      console.log('   Redémarrez ce script dans 10 secondes.');
      await client.end();
      return;
    }
    ...
    console.log('💡 Assurez-vous que le backend a fini de démarrer.');
  }
}
