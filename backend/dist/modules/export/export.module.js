...
exports.ExportModule = ExportModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([export_entity_1.ExportModuleEntity])],
        controllers: [export_controller_1.ExportModuleController],
        providers: [export_service_1.ExportModuleService],
        exports: [export_service_1.ExportModuleService],
    })
], ExportModule);
