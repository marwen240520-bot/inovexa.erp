    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/invoices`, {
        ...
        body: JSON.stringify({
          ...
          operationNumber,
          type: modalForm.type,
          clientId: modalForm.type === "debit" && modalForm.clientId ? parseInt(String(modalForm.clientId), 10) : null,
          supplierId: modalForm.type === "credit" && modalForm.supplierId ? parseInt(String(modalForm.supplierId), 10) : null,
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/invoices/${invoiceToUpdate.id}`, {
        ...
        body: JSON.stringify({
          ...
          clientId: editModalForm.type === "debit" && editModalForm.clientId ? parseInt(String(editModalForm.clientId), 10) : null,
          supplierId: editModalForm.type === "credit" && editModalForm.supplierId ? parseInt(String(editModalForm.supplierId), 10) : null,
